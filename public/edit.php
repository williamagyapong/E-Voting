...
if(isset($_POST['save1'])) {
	...
	if(update('voters', $_SESSION['EDIT-ID'], [
	...
	if(!empty($_FILES['image']['name'])) {
		...
		if(uploadImage($_FILES['image'])) {
			...
			if(update('candidates', $_SESSION['EDIT-ID'], [
	...
	if(update('offices', $_SESSION['EDIT-ID'], [
     ...
     ?>
      ...
      <form action="edit.php" method="post" enctype="multipart/form-data">
	     <fieldset class="fieldset">
	  	...
	  	<img src="images/<?php echo $candidate[0]['images'];?>" width="140" height= "140" style="float:right">
	   <div style=" padding-left: 10%">
        ...
        <tr>
     	   ...
     	   <td>
     	   <select name= "office">
     	   	  <option value="<?php echo $value['office_id']?>"><?php echo $value['office']?>
    ...
    <?php elseif(isset($_SESSION['EDIT']) && $_SESSION['EDIT']=="office"):
     ...
     <form action="edit.php" method="post">
	  ...
	  <div style=" padding-left: 20%">
        ...
        <tr>
        	<td>Office</td>
        	<td><input class="text-input" type="text" name="office" value="<?php echo $value['office']?>" ></td>
        </tr>
